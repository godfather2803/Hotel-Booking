    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(txtFrom != null && !txtFrom.isEmpty() && txtTo != null && !txtTo.isEmpty()){
                request.setAttribute("FROM_BOOKING", txtFrom);
                request.setAttribute("TO_BOOKING", txtTo);
                String email = (String) session.getAttribute("EMAIL");
                String msg = "";
                BookingDAO bookingDAO = new BookingDAO();
                ArrayList<BookingDTO> listBooking = bookingDAO.getBookingHistoryByDates(email, txtFrom, txtTo);
                if(listBooking == null){
                    msg = "Hỏng kiếm thấy gì trơn";
                } else{
                    request.setAttribute("LIST_BOOKING", listBooking);
                }
                request.setAttribute("SEARCH_BOOKING_HISTORY_MSG", msg);
            }else{
